...
file_paths = {
    "HFSSDesign5": {
        "param_file": "F:/python/phone/loop/LOOP EFFICIENCY MOVE FEED={}_my={}.csv",
        "field_plot_file": "F:/python/phone/loop/LOOP CURRENT MOVE FEED={}_my={}.aedtplt"
    },
    "HFSSDesign3": {
        "SAR_plot_file": "F:/python/phone/loop/LOOP SAR MOVE FEED={}_my={}.aedtplt",
        "E_plot_file": "F:/python/phone/loop/LOOP E MOVE FEED={}_my={}.aedtplt"
    }
}
